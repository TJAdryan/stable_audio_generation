...
Git tracks the `exports/` directory via `exports/.gitkeep`, but ignores generated audio files inside it. This keeps local renders on disk without committing large binary outputs.  This is purely speculative but there is room for improvement here.
